 ...
 */
public class BaiduMapActivity extends Activity implements LocationListener, OnClickListener,
        OnHttpListener {
    // 定位相关
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(mLatitude) && !TextUtils.isEmpty(mLongitude)) {
            LatLng cenpt = new LatLng(Double.parseDouble(mLatitude), Double.parseDouble
					(mLongitude));
            //定义地图状态
    ...
    //http://192.168.3.7:9002/web/api/invoke/855c6320993b4cf0968ae1503a849a5a/c_Recipe
	// .drugstore_recommended?
    ...
    public void getInfo(String city, String latitude, String longitude) {
        ...
        //if (!getlocation) {
        String s = "drug/goods/salesLog/getRecommendedDrugStoreList";
        ...
        //if (!TextUtils.isEmpty(city)&&!TextUtils.isEmpty(latitude)&&!TextUtils.isEmpty
		// (longitude)) {
    ...
    public class MyLocationListenner implements BDLocationListener {
        ...
        public void onReceiveLocation(BDLocation location) {
            ...
            if (!TextUtils.isEmpty(city)) {
                SharedPreferenceUtil.putString(BaiduMapActivity.this, SharePrefrenceConst
						.MEDICINE_INFO, city);
            ...
            if (!TextUtils.isEmpty(location.getLatitude() + "")) {
                SharedPreferenceUtil.putString(BaiduMapActivity.this, "mLatitude", location
						.getLatitude() + "");
            }
            if (!TextUtils.isEmpty(location.getLongitude() + "")) {
                SharedPreferenceUtil.putString(BaiduMapActivity.this, "mLongitude", location
						.getLongitude() + "");
            }

            if (!TextUtils.isEmpty(location.getLatitude() + "") && !TextUtils.isEmpty(location
					.getLongitude() + "")) {
        ...
        if (!getlocation) {
            if (result instanceof BaiduMapData) {
                ...
                if (result.resultCode == 1) {
                    ArrayList<Drugstorefens> drugstorefens = BaiduMapDataTrans.drugstorefens(data
							.data);
